...
export default function Login() {
  ...
  function handleSubmit(e: FormEvent) {
    ...
    setError('')
    setLoading(true)
    // TODO: wire up to your real auth endpoint.
  ...
  return (
    <div className="relative min-h-screen bg-ground text-text font-body flex items-center justify-center px-6 overflow-hidden">
      ...
      <div className="relative w-full max-w-sm flex flex-col items-center">
        ...
        >
          <p className="font-body text-muted text-sm mb-7">{t('Track your fleet in real time.')}</p>
                ...
                >
                  ...
                  <label className="flex items-center gap-2 font-mono text-xs text-muted mb-6 cursor-pointer">
                    <input
                      ...
                      tabIndex={expanded ? 0 : -1}
                      className="w-3.5 h-3.5 accent-[#00ff6e]"
                    />
                    {t('Remember me')}
                  </label>
                </div>
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            <p className="font-mono text-xs text-muted">
              ...
              <a href="/signup" className="text-neon hover:text-neon-dim transition-colors">
                {t('Sign up')}
              </a>
            </p>
          </div>
